...
fun poll06(): Flow<String> {
    return flow {
        val inv = <!TYPE_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>select<!>(foo7(), ::Foo7)
        inv
    }
}
...
fun poll86(): Flow<String> {
    return flow {
        val inv = ::Foo7 <!TYPE_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>in<!> <!TYPE_INFERENCE_NO_INFORMATION_FOR_PARAMETER, TYPE_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>setOf<!>(::Foo7)
        inv
    }
}
...
fun poll87(): Flow<String> {
    return flow {
        val inv = ::Foo7 <!TYPE_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>in<!> setOf(foo7())
        inv
    }
}
...
fun poll88(): Flow<String> {
    return flow {
        val inv = foo7() in <!TYPE_INFERENCE_NO_INFORMATION_FOR_PARAMETER, TYPE_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>setOf<!>(::Foo7)
        inv
    }
}
