...
internal fun CompilerConfiguration.loadPlugins() {
    ...
    val k2Registrars =
        classLoader.loadServices<K2PluginRegistrar>(scriptCompilationDisabledPlugins, SCRIPT_COMPILATION_DISABLE_PLUGINS_PROPERTY)
    addAll(K2PluginRegistrar.K2_PLUGIN_REGISTRARS, k2Registrars)
