...
import org.jetbrains.kotlin.analysis.project.structure.RegisteredExtensionsProvider
...
internal fun FirSession.registerCompilerPluginExtensions(project: Project, module: KtSourceModule) {
    val extensionProvider = project.getService(RegisteredExtensionsProvider::class.java) ?: return
